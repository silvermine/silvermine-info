...
These standards supplement the [general Silvermine coding standards](../coding-standards.md).
Where these standards conflict with the general standards, these Kotlin-specific standards
take precedence.
...
## Comments
   ...
   * Use KDoc for documenting public APIs — KDoc replaces JSDoc as referenced in the general
     standards
